...
class Mode:
    def __init__(self, partner):
        ...
        # # Start button
        # self.start_button = Button(self.mode_frame, text="Start",
        ...
        #
        # self.start_button_frame = Frame(self.mode_box)
        ...
        self.easy_frame = Frame(self.mode_box)
        self.easy_frame.grid()

        # Medium mode button
        self.Medium_button = Button(self.mode_frame, text="Medium",
                                    font="arial 15 bold", width=10, padx=10, pady=10, bg="Dark blue", fg="white",
                                    command=self.mode_frame)
        self.Medium_button.grid(row=2, pady=10)

        # Hard mode button
        self.Hard_button = Button(self.mode_frame, text="Hard",
                                  font="arial 15 bold", width=10, padx=10, pady=10, bg="Red4", fg="white",
                                  command=self.mode_frame)
